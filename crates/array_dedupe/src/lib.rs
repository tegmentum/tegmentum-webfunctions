...
impl Guest for Component {
    ...
    fn aggregate_step(_a: Vec<Value>, _m: u64) -> Result<(), String> {
        Err("array_dedupe: aggregate not applicable".into())
    }
        ...
        BindingSets {
            ...
            rows: vec![vec![Binding {
                ...
                value: string_literal(
                    "array_dedupe(array) -> array with consecutive duplicates removed \
                     (Unix uniq semantics). For full deduplication use array_unique."),
            }]],
        }
    }
}
