...
impl Guest for Component {
    ...
    fn aggregate_step(_a: Vec<Value>, _m: u64) -> Result<(), String> {
        Err("string_case_decapitalize: aggregate not applicable".into())
    }
        ...
        BindingSets {
            ...
            rows: vec![vec![Binding {
                ...
                value: string_literal(
                    "string_case_decapitalize(s [, rest_to_lower]) -> lowercase first char, optionally lowercase the rest (default true)."),
            }]],
        }
    }
}
