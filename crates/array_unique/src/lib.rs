...
impl Guest for Component {
    fn evaluate(args: Vec<Value>) -> Result<BindingSets, String> {
        ...
        Ok(BindingSets {
            ...
            rows: vec![vec![Binding { name: "result".into(), value: encode_array_json(seen) }]],
        })
    }

    fn aggregate_step(_a: Vec<Value>, _m: u64) -> Result<(), String> {
        Err("array_unique: aggregate not applicable".into())
    }
        ...
        BindingSets {
            ...
            rows: vec![vec![Binding {
                ...
                value: string_literal(
                    "array_unique(array) -> array with all duplicates removed, \
