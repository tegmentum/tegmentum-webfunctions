...
impl Guest for Component {
    ...
    fn aggregate_step(_args: Vec<Value>, _mult: u64) -> Result<(), String> {
        Err("similarity_jaro_winkler: aggregate not applicable".into())
    }
        ...
        BindingSets {
            ...
            rows: vec![vec![Binding {
                ...
                value: string_literal(
                    "similarity_jaro_winkler(a, b) -> Jaro-Winkler similarity between a and b in [0.0, 1.0] (via strsim crate)."),
            }]],
        }
    }
}
