...
impl Guest for Component {
    ...
    fn aggregate_step(_args: Vec<Value>, _mult: u64) -> Result<(), String> {
        Err("similarity_osa_distance: aggregate not applicable".into())
    }
        ...
        BindingSets {
            ...
            rows: vec![vec![Binding {
                ...
                value: string_literal(
                    "similarity_osa_distance(a, b) -> Optimal String Alignment distance between a and b (via strsim crate)."),
            }]],
        }
    }
}
